...
public class Stimulus {
	...
	public static String[] getStimulus() {
		return mStimulus;
	}
...
/*
		...
		2. Please take force breath 2 times

		3. Please cough 3 times.

		4. Take a deep breath in and say 'Aaa' as in 'Basket'  while breathing out.

		5. Take a deep breath in and say 'Ooo' as in 'Horrible'  while breathing out.

		6. Take a deep breath in and say 'Eee' as in 'peace'  while breathing out.

		7. Take a deep breath in and say 'Sss' as in 'Shakira'  while breathing out.

		8. Take a deep breath in and say 'Uuu' as in 'You'  while breathing out.
